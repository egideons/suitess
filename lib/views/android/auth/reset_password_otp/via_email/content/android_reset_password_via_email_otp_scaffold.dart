...
class AndroidResetPasswordViaEmailOTPScaffold
    extends GetView<ResetPasswordViaEmailOTPController> {
  const AndroidResetPasswordViaEmailOTPScaffold(
      {required this.userEmail, super.key});
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      kSizedBox,
                      androidResetPasswordViaEmailOTPPageHeader(
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: kDefaultPadding * 2),
          androidResetPasswordViaEmailOTPFormMobile(
            resetPasswordViaEmailController,
            media,
            context,
          ),

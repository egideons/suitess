...
import 'android_login_form_landscape.dart';
import 'android_login_form_mobile.dart';
import 'android_login_page_form_header.dart';
import 'android_login_page_header.dart';

class AndroidLoginScaffold extends GetView<LoginController> {
  const AndroidLoginScaffold({super.key});
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Obx(
                        () {
                          return androidLoginFormLandscape(
        ...
        children: [
          ...
          Stack(
            children: [
              ...
              // Welcome back Text
              androidLoginPageHeader(colorScheme: colorScheme, media: media),
            ],
          ),

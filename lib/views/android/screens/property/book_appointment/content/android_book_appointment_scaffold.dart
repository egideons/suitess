...
import 'android_book_appointment_calendar.dart';
import 'android_reference_booking_apartment.dart';

class AndroidBookAppointmentScaffold
    extends GetView<BookAppointmentController> {
  const AndroidBookAppointmentScaffold({super.key});
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child:
                        androidBookAppointmentCalender(controller, colorScheme),
                  ),
                  kSizedBox,
                  Text(
                    "Time preference",
                  ...
                  kHalfSizedBox,
                  androidReferenceBookingApartment(
                    colorScheme,
                    media,

...
class EditContactPhoneOtpController extends GetxController {
  static EditContactPhoneOtpController get instance {
    return Get.find<EditContactPhoneOtpController>();
  }

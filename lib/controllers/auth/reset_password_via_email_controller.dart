...
import '../../../views/android/auth/reset_password_otp/via_email/screen/android_reset_password_via_email_otp.dart';
    ...
    if (formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          await Get.to(
            () => AndroidResetPasswordViaEmailOTP(userEmail: emailEC.text),
